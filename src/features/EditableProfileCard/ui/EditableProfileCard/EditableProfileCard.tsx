...
const EditableProfileCard: React.FC<IEditableProfileCardProps> = memo(
    ({ className, id }: IEditableProfileCardProps) => {
        const { t } = useTranslation('profile');

        const dispatch = useAppDispatch();

        const formData = useSelector(ProfileSelectors.getProfileForm);
