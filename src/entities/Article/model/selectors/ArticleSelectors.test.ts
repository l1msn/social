...
describe('testing getArticleData functional', () => {
    test('return data', () => {
        ...
        expect(ArticleSelectors.getArticleData(state as IStateSchema)).toEqual(mockData);
    });

    test('return empty', () => {
        const state: DeepPartial<IStateSchema> = {};
        expect(ArticleSelectors.getArticleData(state as IStateSchema)).toEqual(undefined);
    });
});
...
describe('testing getArticleError functional', () => {
    test('return error', () => {
        ...
        expect(ArticleSelectors.getArticleError(state as IStateSchema)).toEqual('error');
    });
...
describe('testing getArticleIsLoading functional', () => {
    test('return data', () => {
        ...
        expect(ArticleSelectors.getArticleIsLoading(state as IStateSchema)).toEqual(false);
    });
