...
const ArticlesInfiniteList: React.FC<IArticlesInfiniteListProps> = ({className}: IArticlesInfiniteListProps): JSX.Element => {
    const articles = useSelector(getArticles.selectAll);
    const isLoading = useSelector(ArticlesPageSelectors.getArticlesPageIsLoading);
