...
>('articlePage/fetchArticlesList', async (_, thunkAPI) => {
    try {
        const page = ArticlesPageSelectors.getArticlesPageNumber(
            thunkAPI.getState(),
        );
        const order = ArticlesPageSelectors.getArticlesPageOrder(
            thunkAPI.getState(),
        );
        const sort = ArticlesPageSelectors.getArticlesPageSort(
            thunkAPI.getState(),
        );
        const search = ArticlesPageSelectors.getArticlesPageSearch(
            thunkAPI.getState(),
        );
        const type = ArticlesPageSelectors.getArticlesPageType(
            thunkAPI.getState(),
        );
        ...
        const limit = ArticlesPageSelectors.getArticlesPageLimit(
            thunkAPI.getState(),
        );
